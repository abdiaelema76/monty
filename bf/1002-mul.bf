#BrainF*ck Script that multiplies two numbers and print the result
#Result should be less than 10 (a single digit number)
#given example 32: 3 will be in block #1 and 2 will be in block #2
#block #0 will store the result
#block #1 will hold the value to multiply
#block #2 will hold the amount of times to multiply
#the result of input 32 will output the result of 3*2
...
<-] MOVE TO BLOCK 2 AND DECREASE (DONE WIH FIRST ITERATION)
